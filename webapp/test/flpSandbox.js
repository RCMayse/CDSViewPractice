		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CDS View Practice",
									"targetURL": "#CDSViewPractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CDSViewPractice-display": {
								"semanticObject": "CDSViewPractice",
								"action": "display",
								"description": "Testing out CDS views",
								"title": "CDS View Practice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MyTestApp.CDSViewPractice",
									"url": sap.ui.require.toUrl("MyTestApp/CDSViewPractice")
								}
							}
						}
					}
