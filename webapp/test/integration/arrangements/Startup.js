sap.ui.define([
	"sap/ui/test/Opa5",
	"MyTestApp/CDSViewPractice/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("MyTestApp.CDSViewPractice.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "MyTestApp.CDSViewPractice",
					async: true
				},
				hash: oOptions.hash,
